...
function TrackingRuleManager() {
  ...
  const filteredRules = useMemo(() => {
    ...
    return rules.filter((rule) => {
      ...
      return matchesCase && matchesType && matchesStatus && (!query || haystack.includes(query));
    });
      ...
      >
        <SheetContent side="right" className="w-full sm:max-w-xl">
          <SheetHeader>
            ...
            <SheetDescription>Map brand keywords and search queries to a case so ingestion stays editable from the admin console.</SheetDescription>
          </SheetHeader>
        ...
        {isAdmin && (
          <Card>
            <CardHeader>
              ...
              <p className="text-xs text-muted-foreground mt-1">Admin control center for case-linked tracking rules that power monitoring ingestion.</p>
            </CardHeader>
            <CardContent>
              <TrackingRuleManager />
            </CardContent>
